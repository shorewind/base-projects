# Planet Simulation, Tutorial by Tech With Tim
import math
import pygame
pygame.init()
...
FONT = pygame.font.SysFont("Robotica", 16)

class Planet:
    AU = 149.6e6 * 1000
    G = 6.67428e-11
    SCALE = 200 / AU
    TIMESTEP = 3600*24*0.5
    ...
    def draw(self, win):
        ...
        if not self.sun:
            distance_text = FONT.render(f"{round(self.distance_to_sun/(10**9), 1)}E6 km", 1, WHITE)
